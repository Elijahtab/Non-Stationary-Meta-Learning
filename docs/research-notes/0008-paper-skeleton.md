...
| C4 | **Plasticity loss is absent in the heads at this horizon** — head dormant-unit fraction *falls* 0.9→0.35, never accumulates; **scope-corrected 2026-07-17:** first-conv-layer encoder dormancy *accumulates* (0.13→0.48, n=8, pre-registered), behavioral cost untested | recovered dormant-fraction probe + LOOP-0016 encoder probe | note 0005 addendum · note 0014 |
