...
| [LOOP-0013](./LOOP-0013-selection-rung.md) | 2026-07-14– | Selection rung done right ($0, home): spawn-until-full allocation fix + reward-fingerprint selector (banked WM reward head) vs value-fit re-run, head-to-head; + A-R1 n=16 extension; gates P-G3d/d-ve/e pre-registered ([log 0010](../research-log/0010-2026-07-14-selection-rung-preregistration.md)) | **OPEN** |
