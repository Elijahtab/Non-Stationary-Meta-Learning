...
| [LOOP-0015](./LOOP-0015-fingerprint-selection.md) | 2026-07-16– | Drift-robust fingerprint selection ($0): bank the full WM per slot (scoring-only, frozen feature space), live WM scores the active slot — selection + fire verification in one mechanism; gates P-FP1/FP2 pre-registered ([log 0013](../research-log/0013-2026-07-16-fingerprint-selection-preregistration.md)) | **OPEN** |
