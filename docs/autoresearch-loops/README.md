...
| [LOOP-0016](./LOOP-0016-encoder-dormancy-probe.md) | 2026-07-17– | Encoder-dormancy probe / W0c ($0, home): probe-only dormancy instrument (encoder conv channels + heads, no resets) rides a plain trained-Brain arm to close paper claim C4's heads-only blind spot; gates P-W0c1/2 pre-registered ([log 0014](../research-log/0014-2026-07-17-encoder-dormancy-preregistration.md)) | open |
