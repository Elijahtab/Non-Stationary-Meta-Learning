...
| [LOOP-0013](./LOOP-0013-selection-rung.md) | 2026-07-14– | Selection rung done right ($0, home): **flip method converges n=16 +0.1188 (52% of slice)**; both content selectors = real nulls — banked heads scored through the live drifting trunk almost never restore (1/55, 9/55) → the frontier is drift-robust fingerprints or the mem-Brain; addendum in flight: trigger hardening @1.5 ([log 0011](../research-log/0011-2026-07-15-trigger-hardening-preregistration.md)) | open (addendum) |
