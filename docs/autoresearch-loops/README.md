...
| [LOOP-0017](./LOOP-0017-conv1-redo-rung.md) | 2026-07-17– | conv1-ReDo rung ($0, home): branch F's first live-targeted intervention — reset accumulating conv1 channels (interval 10, τ=0.025, single disclosed config); P-F1a mechanism / P-F1b composite (+0.05 MDE-honest; null = "behaviorally cheap" bound) ([log 0015](../research-log/0015-2026-07-17-conv1-redo-preregistration.md)) | open |
| [LOOP-0018](./LOOP-0018-action-flip-calibration.md) | 2026-07-17– | IP-1 action-flip calibration ($0, home): master-approved env mode — regimes differ in dynamics (odd regimes mirror left/right), reward fixed; C-IP-a headroom ≥ +0.10 + C-IP-b WM-error persistence ≥ 4 updates decide the port for ~2 GPU-h ([log 0016](../research-log/0016-2026-07-17-action-flip-calibration-preregistration.md)) | open |
