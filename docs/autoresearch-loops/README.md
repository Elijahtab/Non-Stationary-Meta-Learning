...
| [LOOP-0012](./LOOP-0012-g3-head-bank.md) | 2026-07-14 | G3 de-oracling ($0, home): bank ≡ swap (P-G3a); **learned trigger recovers +0.118 = 54% of the ceiling slice** (P-G3b, hit80 1.000); value-error selection null (P-G3c FAIL — value fit carries no regime identity) → selection frontier fork ([note 0013](../research-notes/0013-learned-trigger-selection-gap.md)) | closed |
