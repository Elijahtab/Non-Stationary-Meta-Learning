...
| [LOOP-0012](./LOOP-0012-g3-head-bank.md) | 2026-07-14– | G3 head-bank de-oracling screen ($0, home): oracle-equivalence rung + A-R1 learned trigger (calibrated thr 1.0: prec .84/rec .85) + value-error selection; gates P-G3a/b/c pre-registered ([log 0009](../research-log/0009-2026-07-14-g3-head-bank-preregistration.md)) | **OPEN** |
