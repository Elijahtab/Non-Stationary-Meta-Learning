...
| [LOOP-0011](./LOOP-0011-wave1-oracle-rungs.md) | 2026-07-14– | Wave-1 oracle rungs on the home 5070 ($0): G-DECOMP swap-scope ladder (heads/heads+enc/WM/full vs archived control) + 3-regime screen; pre-registered gates route the memory subtree ([log 0008](../research-log/0008-2026-07-14-wave1-oracle-rungs-preregistration.md)) | **OPEN** |
