...
| [LOOP-0014](./LOOP-0014-step-trigger.md) | 2026-07-15– | Per-step trigger vs the lag wall ($0): model-free success-collapse detector (fast/slow EMAs at episode terminations), 3-iteration shadow calibration disclosed (WM per-event error = noise; final: live-equiv precision ~0.9, median lag ~400 steps); gates P-S1a/b pre-registered ([log 0012](../research-log/0012-2026-07-16-step-trigger-preregistration.md)) | **OPEN** |
