...
| [0014](./0014-2026-07-17-encoder-dormancy-preregistration.md) | 2026-07-17 | Registered gates P-W0c1/2: encoder-dormancy probe (W0c, LOOP-0016) — probe-only instrument closes paper claim C4's heads-only blind spot | Accepted (in flight) |
