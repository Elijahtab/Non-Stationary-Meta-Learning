...
| [0012](./0012-2026-07-16-step-trigger-preregistration.md) | 2026-07-16 | Registered gates P-S1a/b: per-step success-collapse trigger (LOOP-0014) — the lag-wall attack; calibration history disclosed | Registered (pre-results) |
