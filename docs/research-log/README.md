...
| [0015](./0015-2026-07-17-conv1-redo-preregistration.md) | 2026-07-17 | Registered gates P-F1a/b (+harm flag): conv1-targeted ReDo (branch F rung, LOOP-0017) — does eliminating the conv1 accumulation move composite? | Accepted (in flight) |
