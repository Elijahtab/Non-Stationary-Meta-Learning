...
| [0016](./0016-2026-07-17-action-flip-calibration-preregistration.md) | 2026-07-17 | Registered gates C-IP-a/b: IP-1 action-flip instrument calibration (LOOP-0018) — headroom + regime-signal persistence decide the port | Accepted (queued behind LOOP-0017) |
