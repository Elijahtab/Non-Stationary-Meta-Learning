...
| [0010](./0010-2026-07-14-selection-rung-preregistration.md) | 2026-07-14 | Registered gates P-G3d/d-ve/e: selection re-run with spawn-until-full allocation — reward fingerprint vs value fit head-to-head + ar1 n=16 (LOOP-0013) | Registered (pre-results) |
