> **ARCHIVED 2026-07-05** — superseded by the restructured [AUTORESEARCH.md](../../AUTORESEARCH.md)
> (checklist + decisions register + loop-note index; see
> [docs/plans/2026-07-05-autoresearch-md-restructure.md](../plans/2026-07-05-autoresearch-md-restructure.md)).
> Load-bearing ops content moved to [cloud-setup.md](../plans/cloud-setup.md); per-loop state
> lives in [docs/autoresearch-loops/](../autoresearch-loops/). Preserved verbatim below —
> NOTE: its "Composite Score" section describes the pre-2026-06-18 formula (stale even at
> archive time; see research-log 0001).
