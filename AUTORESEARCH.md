...
- [LOOP-0011 — Wave-1 oracle rungs](docs/autoresearch-loops/LOOP-0011-wave1-oracle-rungs.md): OPEN (launched 2026-07-14, home 5070, $0) — G-DECOMP swap-scope ladder (4 scopes × n=8 vs archived loop9_s1 control) then the 3-regime screen; gates pre-registered in [research-log 0008](docs/research-log/0008-2026-07-14-wave1-oracle-rungs-preregistration.md) BEFORE results; user call 2026-07-14: home-only, box request goes to the user at Wave 2
