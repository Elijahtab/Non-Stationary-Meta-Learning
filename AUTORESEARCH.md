...
- [LOOP-0017 — conv1-ReDo rung (branch F)](docs/autoresearch-loops/LOOP-0017-conv1-redo-rung.md): OPEN (2026-07-17, home, $0, user green-light) — LOOP-0016 armed branch F (conv1 dormancy accumulates); this rung resets dormant conv1 channels (single disclosed config: interval 10, τ=0.025) and asks if the composite moves; P-F1a mechanism gate read before P-F1b (+0.05 MDE-honest bar; registered null reading = "first-layer plasticity loss is behaviorally cheap") ([log 0015](docs/research-log/0015-2026-07-17-conv1-redo-preregistration.md))
