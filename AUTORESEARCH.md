...
- [LOOP-0013 — selection rung done right](docs/autoresearch-loops/LOOP-0013-selection-rung.md): OPEN (launched 2026-07-14 night, home, $0) — spawn-until-full allocation + reward-fingerprint selector (banked 257-param WM reward head) vs value-fit re-run head-to-head + A-R1 n=16 extension; gates P-G3d/d-ve/e pre-registered ([log 0010](docs/research-log/0010-2026-07-14-selection-rung-preregistration.md)); both-fail routes selection to the mem-Brain lever (box ping)
