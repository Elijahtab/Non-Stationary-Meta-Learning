...
- [LOOP-0016 — encoder-dormancy probe (W0c)](docs/autoresearch-loops/LOOP-0016-encoder-dormancy-probe.md): OPEN (launched 2026-07-17, home, $0, user direction) — closes paper claim C4's blind spot: the "plasticity loss absent" verdict was measured on heads only; a probe-only dormancy instrument (encoder conv channels + actor/critic heads, τ=0.025, no resets, flag-guarded default-off) rides a plain trained-Brain eval arm (`dorm_e1..8`); P-W0c2 (integrity: heads fall replicates C4, composite inert vs archived control) read before P-W0c1 (encoder no-accumulation: median rise from early trough ≤ +0.05/layer) ([log 0014](docs/research-log/0014-2026-07-17-encoder-dormancy-preregistration.md))
