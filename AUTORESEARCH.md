...
- [LOOP-0018 — IP-1 action-flip calibration](docs/autoresearch-loops/LOOP-0018-action-flip-calibration.md): OPEN (2026-07-17, home, $0, user approved the master env edit) — the instrument port's go/no-go for ~2 GPU-h: `regime_effect="action_flip"` (odd regimes mirror left/right, reward fixed — dynamics-differing regimes, note 0015); C-IP-a headroom (O2-analog ≥ +0.10) + C-IP-b premise (WM next-state-error persistence ≥ 4 updates at true switches) ([log 0016](docs/research-log/0016-2026-07-17-action-flip-calibration-preregistration.md))
