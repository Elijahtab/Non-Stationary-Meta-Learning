...
but present layer-locally at the input layer. Whether the first-layer
accumulation carries any composite cost is untested (no intervention has
been run against it); every arm reported here, including the oracle
ceiling, trained under it.
...
accumulation ($0.13 \to 0.48$) whose behavioral cost, if any, is unmeasured
--- no intervention has been run against it. \composite{} is one facet
